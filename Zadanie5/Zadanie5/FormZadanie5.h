...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->сохранитьДанныеТаблицыВФайлToolStripMenuItem->Size = System::Drawing::Size(268, 22);
			this->сохранитьДанныеТаблицыВФайлToolStripMenuItem->Text = L"Сохранить данные таблицы в файл";
			this->сохранитьДанныеТаблицыВФайлToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::сохранитьДанныеТаблицыВФайлToolStripMenuItem_Click);
			// 
			// графикToolStripMenuItem
			// 
			this->графикToolStripMenuItem->Name = L"графикToolStripMenuItem";
			this->графикToolStripMenuItem->Size = System::Drawing::Size(268, 22);
			this->графикToolStripMenuItem->Text = L"Выход";
			this->графикToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::графикToolStripMenuItem_Click);
			// 
			...
			this->таблицаToolStripMenuItem->Size = System::Drawing::Size(121, 22);
			...
			this->цветТекстаToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::цветТекстаToolStripMenuItem_Click);
			// 
			...
			this->цветФонаЯчеекToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::цветФонаЯчеекToolStripMenuItem_Click);
			// 
			...
			this->высотаСтрокToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::высотаСтрокToolStripMenuItem_Click);
			// 
			...
			this->ширинаСтолбцовToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::ширинаСтолбцовToolStripMenuItem_Click);
			// 
			...
			this->параметрыШрифтаЗаголовкаToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::параметрыШрифтаЗаголовкаToolStripMenuItem_Click);
			// 
			...
			this->цветШрифтаЗаголовкаToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::цветШрифтаЗаголовкаToolStripMenuItem_Click);
			// 
			// графикToolStripMenuItem1
			// 
			this->графикToolStripMenuItem1->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
			...
			this->графикToolStripMenuItem1->Size = System::Drawing::Size(121, 22);
			...
			this->цветГрафикаToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::цветГрафикаToolStripMenuItem_Click);
			// 
			...
			this->цветФонаГрафикаToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::цветФонаГрафикаToolStripMenuItem_Click);
			// 
			...
			this->выходToolStripMenuItem->Click += gcnew System::EventHandler(this, &FormZadanie5::выходToolStripMenuItem_Click);
			// 
			// button1
			// 
			...
			this->label5->Text = L"Введите положительное число a=";
			// 
			// label4
			// 
			...
			this->label6->Text = L"Таблица значений функции на прмежутке [xn;xk]";
			// 
			// tabPage3
			// 
			...
			this->Text = L"Выполнил студент группы 23-КФ Киселев С.Р. задание 5";
